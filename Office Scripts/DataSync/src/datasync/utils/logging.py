"""
Comprehensive logging configuration module for DataSync.
Combines simple setup functions with advanced YAML-based configuration.
"""
...
def setup_logger(name: str = None, level: int = logging.INFO) -> logging.Logger:
    ...
    Simple interface for basic logging needs.
